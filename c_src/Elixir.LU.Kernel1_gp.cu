...
__global__
void kernel1(float *a, int n, int k)
{
...
extern "C" void kernel1_call(ErlNifEnv *env, const ERL_NIF_TERM argv[], ErlNifResourceType* type)
  {
  ...
  list = tail;
   ...
   kernel1<<<blocks, threads>>>(arg1,arg2,arg3);
